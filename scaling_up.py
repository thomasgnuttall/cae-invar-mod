...
from exploration.visualisation import plot_subsequence

stt = lambda y: int(y/timestep)

plot_subsequence(stt(60), stt(5), raw_pitch, time, timestep, path='random/subsequence.png', plot_kwargs=plot_kwargs)




matrix_mask[2000:3000]
